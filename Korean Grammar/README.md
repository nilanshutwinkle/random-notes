...
## Contents
* **[(만약) ~(으)면](#-4384882538602877859)**: in case, if
* **[(으)시](#-4792146505790068207)**: present tense
* **[... 뭐예요?](#968426925767118000)**
* **[..., ...?](#-784967391711134795)**: alternative questions
* **[A(가/이) B보다](#3696237347242483017)**: A more than B
* **[A(가/이) B보다 더](#-208057418072349837)**: A more than B
* **[A(가/이) B보다 덜](#7266258059937695902)**: A less than B
* **[~(ㄴ/는) 것 같아요](#5117097004051576351)**
* **[~(ㄹ) 수 없다](#6831670827488342706)**: to be unable
* **[~(ㄹ) 수 있다](#1195739952093894518)**: to be able
* **[~(는)noun](#-8224490132604326165)**: present-tense verbs
* **[~(아/어) 보다](#-7053291372140428581)**
* **[~(어/아)서](#-650172575021315074)**: sequential cause-and-effect
* **[~(어/아)서](#-6610824518130585418)**: so
* **[~(었/았/ㅆ)어요](#7767779748032935043)**
* **[~(으)ㄴ noun](#4077645640161849207)**: adjectives
* **[~(으)ㄴ noun](#1048759811976675942)**: past-tense verbs
* **[~(으)ㄴ데](#-1965930579568785813)**: background info&mdash;adjectives and 이다
* **[~(으)ㄴ데요/는데요](#8861903550654818152)**
* **[~(으)ㄹ noun](#1072074346030845281)**: future-tense verbs
* **[~(으)ㄹ 거예요](#-3533196648202108065)**
* **[~(으)ㄹ 때](#-1723128988435209902)**: when
* **[~(으)ㄹ 줄 모르다](#7408948456858526098)**: to not know how to do
* **[~(으)ㄹ 줄 알다](#-120195363227960462)**: to know how to do
* **[~(으)ㄹ게요](#-2867708504949422873)**: volunteer
* **[~(으)ㄹ까요?](#752541332542671101)**
* **[~(으)ㄹ래요](#161593944864322694)**: intentional, colloquial
* **[~(으)러](#3889516795605399015)**
* **[~(으)로](#-7530035581743606485)**
* **[~(으)로](#5131894698302448854)**: using
* **[~(으)로 가다/오다](#-5172502893178695013)**: to come or go by
* **[~(으)면서](#8677422222538886426)**: while ~ing
* **[~(으)셨습니다](#4584050407302197012)**: deferential honorific past-tense
* **[~(으)십니다](#2841271724979066127)**: deferential honorific
* **[~(은/는)요?](#-3640020610644675022)**
* **[~(이)나](#-3028122636255893613)**: emphasize a lot
* **[~(이)라서](#-3173827027069372237)**: because; 이다 + 어서/아서
* **[~(이)랑](#3316236229056659681)**: and, with; colloquial
* **[~(이)랑 같이](#8291135923805787148)**: together
* **[~ㄴ/ㄹ/는 것](#-8481344112854137350)**: adjectives and nouns
* **[~게](#-5106361129167106483)**: adverbial form
* **[~고](#-6829796019237811206)**: and then
* **[~고](#-8307843438596245969)**: and
* **[~고 나서](#7556471706520281359)**: after
* **[~고 듣다](#2904685437561580144)**
* **[~고 싶다](#4821450719478312424)**: to want
* **[~고 있다](#-7057871435816567178)**
* **[~고요](#3759566242254562139)**
* **[~기](#-8269796181589915054)**: convert verbs to nouns
* **[~께](#-2894889194754202930)**: to person, honorific
* **[~께서](#1767618097066507336)**: honorific subject marker
* **[~네요](#-7848311362039171710)**: just learned
* **[~는데](#-3633542192453859642)**: background info&mdash;verbs and 있다, 없다
* **[~밖에](#8684307468614513501)**: emphasize a little
* **[~부터 ~까지](#-7776352413696823258)**: from ... to ... in time
* **[~부터 동안](#4911761106290868762)**: from ... for ... long
* **[~습니까/ㅂ니까?](#-5229805075481391656)**: deferential question
* **[~습니다/ㅂ니다](#-5210118505024022947)**: deferential statement
* **[~어/아 주다](#-3652326435693217215)**: do something for someone else
* **[~어/아야 되다](#-6982614282373439474)**: colloquial
* **[~어/아야 하다](#-8764598979732179015)**: slightly formal
* **[~었/았습니다](#472660481378052937)**: deferential past-tense
* **[~에](#-882009550566974622)**: goal
* **[~에](#5512998853044336011)**: to place
* **[~에 대해서](#-8654431579489892010)**: about
* **[~에는 ...이/가 있어요](#8911881064230004694)**
* **[~에서](#-3297218287865864241)**: dynamic location
* **[~에서 ~까지](#-3941800858955721362)**: from ... to ... a place
* **[~은/는 ~에 있어요](#-8153461470598158353)**: static location
* **[~의](#-7936603529515052821)**
* **[~이/가 아니라서](#-5658848894299012015)**: because not; 아니다 + 어서/아서
* **[~이/가 어디 있어요?](#7819494912068753288)**
* **[~이/가 어때요?](#-7825305114930317392)**
* **[~지 마세요](#-7370852028964180910)**: negative commands
* **[~지 못하다](#-6496455747341888795)**: can't do
* **[~지 않다](#2611351016490919260)**: to not do, to not be
* **[~지만](#6410484993291517664)**: but
* **[~지요?](#-2810109696287948231)**
* **[~하고](#8247494566299810258)**: and, with
* **[~한테](#8093581948219701036)**: to person
* **[~한테서](#-6172627816941714301)**: from person
* **[겠](#-3271332665479860241)**: conjecture, politeness
* **[겠](#5368835435674673150)**: intentional
* **[그런데](#-612125150960558817)**
* **[대까지](#8046503677067016739)**: since
* **[때](#-1125778550885633589)**: when
* **[때문에](#-4408779160396997599)**: because of
* **[무슨](#3087902449267267973)**: what kind of
* **[별로](#-929905453614883873)**: not really
* **[셨](#3782248169833151135)**: past-tense
* **[아니라](#-7237459217097973720)**: not this, that
* **[아니요, ... 안/못](#5756144008682887474)**: won't or can't
* **[아니요, ~이/가 아니에요](#183664761560873848)**: to not be
* **[어느](#2079796198486705162)**: which
* **[은/는 ~이에여/예요](#-2461978633870195486)**: to be
* **[전혀](#3121118188551035649)**: not at all
* **[중에서](#-6111517677063340315)**: between
* **[하나도](#777929891621128452)**: not at all; colloquial

<a name="-4384882538602877859"></a>
## (만약) ~(으)면 (in case, if)
...
<a name="968426925767118000"></a>
## ... 뭐예요?

**이게 뭐예요?**
What is this thing?

<a name="-784967391711134795"></a>
## ..., ...? (alternative questions)

**여자친구가 있어요, 없어요?**
Do you or do you not have a girlfriend?

<a name="3696237347242483017"></a>
## A(가/이) B보다 (A more than B)

**오늘은 어제보다 더워요.** (source: TTMIK)
Today is warmer than yesterday.

<a name="-208057418072349837"></a>
...
<a name="7266258059937695902"></a>
## A(가/이) B보다 덜 (A less than B)

<a name="5117097004051576351"></a>
## ~(ㄴ/는) 것 같아요
...
**저는 혼자 있는 거 좋아해요.** (source: TTMIK)
I like living alone.

**요즘 혼술이 유행인 거 알아요? 혼술은 혼자 술 마시는 것을 말해요.** (source: TTMIK)
...
<a name="3889516795605399015"></a>
## ~(으)러

**친구 만나러 버스를 타요.**
I'm riding the bus to meet a friend.

<a name="-7530035581743606485"></a>
## ~(으)로
...
<a name="-3028122636255893613"></a>
## ~(이)나 (emphasize a lot)

**이번 주 3 시험이나 봤어요?**
You took three tests this week?

<a name="-3173827027069372237"></a>
...
<a name="-8307843438596245969"></a>
## ~고 (and)

**집이 넓고 지하철 역에서 가까워요.**
My home is spacious and close to the subway station.

<a name="7556471706520281359"></a>
## ~고 나서 (after)
...
<a name="2904685437561580144"></a>
## ~고 듣다

**예쁘다고 들었어요.**
I heard (she) is pretty.

<a name="4821450719478312424"></a>
## ~고 싶다 (to want)

**한국어를 더 잘 하고 싶어요.**
I want to get better at Korean.

<a name="-7057871435816567178"></a>
## ~고 있다
...
<a name="-8764598979732179015"></a>
## ~어/아야 하다 (slightly formal)

**매일 공부해야 해요.**
I have to study everyday.

<a name="472660481378052937"></a>
...
<a name="-882009550566974622"></a>
## ~에 (goal)

**집에 가요.**
I'm going home.

<a name="5512998853044336011"></a>
## ~에 (to place)

**사무실에 가요.**
I'm going to the office.

<a name="-8654431579489892010"></a>
## ~에 대해서 (about)
...
<a name="8911881064230004694"></a>
## ~에는 ...이/가 있어요

**3충에는 한국어 수업이 있어요.**
The Korean class is on the 3rd floor.

<a name="-3297218287865864241"></a>
## ~에서 (dynamic location)

**커피셥에서 공부해요.**
I'm studying at the coffee shop.

<a name="-3941800858955721362"></a>
...
<a name="3087902449267267973"></a>
## 무슨 (what kind of)

**이거 무슨 음식이에요?**
What kind of food is this?

<a name="-929905453614883873"></a>
## 별로 (not really)
...
<a name="3782248169833151135"></a>
## 셨 (past-tense)

**이 선생님 학교에 계셨어요.**
Mrs. Lee was at school.

<a name="-7237459217097973720"></a>
## 아니라 (not this, that)

**달리기가 아니라 수양할래요.**
I want to swim, not run.

<a name="5756144008682887474"></a>
...
<a name="183664761560873848"></a>
## 아니요, ~이/가 아니에요 (to not be)

**아니요, 중국 사람이 아니에요.**
No, I'm not a Chinese person.

<a name="2079796198486705162"></a>
## 어느 (which)

**어느 치킨 식당에 만아요?**
Which chicken restaurant are we meeting at?

<a name="-2461978633870195486"></a>
## 은/는 ~이에여/예요 (to be)

**저는 미국 사람이에요.**
I'm an American.

<a name="3121118188551035649"></a>
## 전혀 (not at all)
*Verb must be negative.*
